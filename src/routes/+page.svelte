		...
		<div>
			...
			<div class="code-block">
				<p class="code-text">
					...
					https://github.com/pace-rs/pace/releases/download/pace-rs-v0.13.0/pace-rs-installer.sh | sh
				</p>
			</div>
			<p>Install prebuilt binaries via shell script (Powershell)</p>
			<div class="code-block">
				<p class="code-text">
					irm https://github.com/pace-rs/pace/releases/download/pace-rs-v0.13.0/pace-rs-installer.ps1
					| iex
				</p>
			</div>
			<p>Download pre-built PACE v0.13.0 from Github Releases</p>
			<Downloads />
		</div>
	</div>
